...
package crefil_eventlogs.jobassertion_1_0;
...
/**
 * Job: JobAssertion Purpose: <br>
 * Description:
 * https://help.talend.com/r/en-US/8.0/logs-and-errors/tassert-tassertcatcher-tfileoutputdelimited-setting-up-assertive-condition-for-job-execution-standard-component-this
 * <br>
 * 
 ...
 * @status
 */
public class JobAssertion implements TalendJob {
	...
	private final String jobName = "JobAssertion";
	private final String projectName = "CREFIL_EVENTLOGS";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JobAssertion.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_CREFIL_EVENTLOGS_JobAssertion = new byte[0];
		static byte[] commonByteArray_CREFIL_EVENTLOGS_JobAssertion = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CREFIL_EVENTLOGS_JobAssertion.length) {
					if (length < 1024 && commonByteArray_CREFIL_EVENTLOGS_JobAssertion.length == 0) {
						commonByteArray_CREFIL_EVENTLOGS_JobAssertion = new byte[1024];
					} else {
						commonByteArray_CREFIL_EVENTLOGS_JobAssertion = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CREFIL_EVENTLOGS_JobAssertion, 0, length);
				strReturn = new String(commonByteArray_CREFIL_EVENTLOGS_JobAssertion, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_CREFIL_EVENTLOGS_JobAssertion, 0, length);
				strReturn = new String(commonByteArray_CREFIL_EVENTLOGS_JobAssertion, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CREFIL_EVENTLOGS_JobAssertion) {
...
///////////////////////    			
				...
				for (AssertCatcherUtils.AssertCatcherMessage acm : tAssertCatcher_1.getMessages()) {
					row4.moment = acm.getMoment();
					row4.pid = acm.getPid();
					row4.project = acm.getProject();
					row4.job = acm.getJob();
					row4.language = acm.getLanguage();

					row4.origin = (acm.getOrigin() == null || acm.getOrigin().length() < 1 ? null : acm.getOrigin());

					row4.status = acm.getStatus();
					row4.substatus = acm.getSubstatus();
					row4.description = acm.getDescription();
...
///////////////////////		
					...
					if (row4.moment != null) { //
						...
						strBuffer_tLogRow_2.append(FormatterUtils.format_Date(row4.moment, "yyyy-MM-dd HH:mm:ss"));
					...
					if (row4.pid != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.pid));
					...
					if (row4.project != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.project));
					...
					if (row4.job != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.job));
					...
					if (row4.language != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.language));
					...
					if (row4.origin != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.origin));
					...
					if (row4.status != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.status));
					...
					if (row4.substatus != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.substatus));
					...
					if (row4.description != null) { //
						...
						strBuffer_tLogRow_2.append(String.valueOf(row4.description));
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CREFIL_EVENTLOGS_JobAssertion) {
				...
				try {
					...
					this.ColumnA = readString(dis);

					this.ColumnB = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.ColumnA, dos);

				// String

				writeString(this.ColumnB, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/out.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/source.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/source.csv", "ISO-8859-15",
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.ColumnA = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.ColumnB = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.ColumnA != null) {
								sb_tFileOutputDelimited_1.append(row1.ColumnA);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row1.ColumnB != null) {
								sb_tFileOutputDelimited_1.append(row1.ColumnB);
							}
					...
					if (!((Object) ("C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/source.csv") instanceof java.io.InputStream)) {
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("file=" + file);
			sb.append(",file_ref=" + file_ref);
			sb.append(",moment=" + String.valueOf(moment));
			sb.append(",job=" + job);
			sb.append(",component=" + component);
			sb.append(",differ=" + String.valueOf(differ));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(
						new String[] { "file", "file_ref", "moment", "job", "component", "differ", "message", });
...
///////////////////////    			
					...
					java.io.BufferedReader file_tFileCompare_1 = new java.io.BufferedReader(
							new java.io.InputStreamReader(
									new java.io.FileInputStream(
											"C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/out.csv"),
									"ISO-8859-15"));
					java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(
							new java.io.InputStreamReader(
									new java.io.FileInputStream(
											"C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/reference.csv"),
									"ISO-8859-15"));
				...
				row2.file = "C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/out.csv";
				row2.file_ref = "C:/Users/dthbk/OneDrive/Desktop/Talend_Workspace/resources/reference.csv";
				...
				if (row2.differ == 0) {
					tAssertCatcher_1.addMessage(pid, projectName, jobName, "java", "tAssert_1", "Ok", "--",
							"The output file should be idential with the reference file.");
					tAssertCatcher_1Process(globalMap);
				} else {
					tAssertCatcher_1.addMessage(pid, projectName, jobName, "java", "tAssert_1", "Failed",
							"Test logically failed", "The output file should be idential with the reference file.");
					tAssertCatcher_1Process(globalMap);
				}
...
///////////////////////		
				...
				if (row3.file != null) { //
					row_tLogRow_1[0] = String.valueOf(row3.file);

				} //

				if (row3.file_ref != null) { //
					row_tLogRow_1[1] = String.valueOf(row3.file_ref);

				} //

				if (row3.moment != null) { //
					row_tLogRow_1[2] = FormatterUtils.format_Date(row3.moment, "yyyy-MM-dd HH:mm:ss");

				} //

				if (row3.job != null) { //
					row_tLogRow_1[3] = String.valueOf(row3.job);

				} //

				if (row3.component != null) { //
					row_tLogRow_1[4] = String.valueOf(row3.component);

				} //

				if (row3.differ != null) { //
					row_tLogRow_1[5] = String.valueOf(row3.differ);

				} //

				if (row3.message != null) { //
					row_tLogRow_1[6] = String.valueOf(row3.message);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final JobAssertion JobAssertionClass = new JobAssertion();

		int exitCode = JobAssertionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = JobAssertion.class.getClassLoader()
					.getResourceAsStream("crefil_eventlogs/jobassertion_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = JobAssertion.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JobAssertion");
		}
...
/************************************************************************************************
 * 101337 characters generated by Talend Open Studio for Data Integration on the
 * August 8, 2022 at 2:10:43 PM ICT
 ************************************************************************************************/