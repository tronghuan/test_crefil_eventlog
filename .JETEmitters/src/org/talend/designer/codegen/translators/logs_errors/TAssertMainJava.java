...
public class TAssertMainJava
{
  ...
  protected final String TEXT_9 = "\", \"Failed\", \"Test logically failed\", ";
  protected final String TEXT_10 = "Process(globalMap);\t" + NL + "}\t\t\t\t\t";
  protected final String TEXT_11 = NL + "if(!";
  protected final String TEXT_12 = "){" + NL + "   if (junitGlobalMap.get(\"tests.log\") == null) {" + NL + "        junitGlobalMap.put(\"tests.log\", new String());" + NL + "   }" + NL + "   if (junitGlobalMap.get(\"tests.nbFailure\") == null) {" + NL + "        junitGlobalMap.put(\"tests.nbFailure\", new Integer(0));" + NL + "   }" + NL + "   junitGlobalMap.put(\"tests.log\",((String)junitGlobalMap.get(\"tests.log\"))+\"";
  protected final String TEXT_13 = ":\"+ ";
  protected final String TEXT_14 = "+java.lang.System.getProperty(\"line.separator\"));" + NL + "   junitGlobalMap.put(\"tests.nbFailure\",((Integer)junitGlobalMap.get(\"tests.nbFailure\"))+1);" + NL + "}else{" + NL + "   assertTrue(";
